...
class RVAdapterNextMatch(private val context: Context?, private val items: List<Event>, private val listener: (Event) -> Unit)
    : RecyclerView.Adapter<RVAdapterNextMatch.ViewHolder>() {
